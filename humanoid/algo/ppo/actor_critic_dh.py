...
class ActorCriticDH(nn.Module):
    def __init__(self, num_short_obs,
        ...
        # filter_size is number of conv kernel, rand generate
        # 1 layer cnn step: rand generate out_channels(32) kernels, each kernel(6) conv obs(47) each stride(3) loop in_channels times(66),
        #           and sum, get (out_channels(32), cnn_output_dim(14))
        long_history_layers = []
