...
class Logger:
    ...
    def _plot(self):
        ...
        # plot contact forces
        a = axs[1, 1]
        if log["dof_torque[12]"]: a.plot(time, log["dof_torque[12]"], label='measured')
    ...
    def _plot_position(self):
        ...
        a = axs[2, 1]
        if log["dof_pos[13]"]: a.plot(time, log["dof_pos[13]"], label='measured')
        if log["dof_pos_target[13]"]: a.plot(time, log["dof_pos_target[13]"], label='target')
